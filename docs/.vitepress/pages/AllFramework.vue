      ...
      >
        ...
        >
          ...
          <div class="card-body p-6">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800 dark:text-gray-100 line-clamp-2 hover:text-brand">{{ framework.title }}</h3>
            <p class="text-gray-600 dark:text-gray-300 mb-4 line-clamp-3">{{ framework.excerpt }}</p>
