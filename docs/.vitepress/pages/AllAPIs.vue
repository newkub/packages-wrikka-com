<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
      <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">API Documentation</h1>
        ...
        <div class="border-t border-gray-100 dark:border-gray-700 pt-4">
          <ul class="space-y-3">
            <li v-for="api in filteredApis.components" :key="api.id" 
                class="hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded cursor-pointer"
                @click="navigateToApi(api.slug)">
              <div class="flex justify-between items-center">
                <span class="font-medium text-gray-800 dark:text-gray-200">{{ api.title }}</span>
                <div class="i-mdi-chevron-right w-5 h-5 text-gray-400"></div>
              </div>
              <p class="text-sm text-gray-600 dark:text-gray-400 mt-1 line-clamp-2">{{ api.excerpt }}</p>
